<template>
       <div class="shadow-sm relative rounded-md bg-white">
            <nuxt-link :to="localePath('/ilanlar')" title="İlanlar" class="relative">
              ...
              >
                <icon
                  name="material-symbols:sell-sharp"
            ...
            <div class="mt-4 px-4 pb-8">
              ...
              <div class="flex flex-row justify-start mt-4 mb-4 items-center gap-8 text-body">
                <p>
                    <Icon
